...
public class BsWriter : BinaryWriter
{
    ...
    public BsWriter(Stream output) : base(output)
    {
        _encoding = Encoding.GetEncoding(949);
    }

    public BsWriter(Stream output, Encoding encoding) : base(output, encoding)
    {
        _encoding = encoding;
    }

    public BsWriter(Stream output, Encoding encoding, bool leaveOpen) : base(output, encoding, leaveOpen)
    {
        _encoding = encoding;
    }
