...
namespace RSBot.Theme
{
    public class ColorScheme
    {
        ...
        public static Color ForeColorSelected => Theme == THEME.DARK ? Color.FromArgb(244, 244, 244) : Color.FromArgb(33, 33, 33);
        public static Color ForeColorDisabled => Theme == THEME.DARK ? Color.FromArgb(188, 188, 188) : Color.FromArgb(99, 99, 99);
