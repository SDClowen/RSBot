...
public partial class BuffProperties : UIWindowBase
{
    ...
    {
        public BuffDebugInformation(SkillInfo skillInfo) : base(skillInfo.Record)
        {
            Id = skillInfo.Id;
        ...
        [Category("SkillInfo")] public uint Id { get; }

        [Category("SkillInfo")] public bool Enabled { get; }

        [Category("SkillInfo")] public bool IsPassive { get; }

        [Category("SkillInfo")] public bool IsAttack { get; }

        [Category("SkillInfo")] public bool IsDot { get; }

        [Category("SkillInfo")] public bool IsImbue { get; }

        [Category("SkillInfo")] public uint Token { get; }

        [Category("SkillInfo")] public bool HasCooldown { get; }

        [Category("SkillInfo")] public bool CanBeCasted { get; }
    }
    ...
    internal class PerkDebugInformation
    {
        ...
        [Category("ItemPerk")] public uint ItemId { get; }

        [Category("ItemPerk")] public uint Token { get; }

        [Category("ItemPerk")] public uint Value { get; }

        [Category("ItemPerk")] public uint RemainingTime { get; }
        ...
        [Category("RefObjItem")] public bool IsEquip { get; }

        [Category("RefObjItem")] public bool IsJobEquip { get; }

        [Category("RefObjItem")] public bool IsStackable { get; }

        [Category("RefObjItem")] public bool IsGold { get; }

        [Category("RefObjItem")] public bool IsTrading { get; }

        [Category("RefObjItem")] public bool IsQuest { get; }

        [Category("RefObjItem")] public bool IsSkillItem { get; }

        [Category("RefObjItem")] public int Degree { get; }

        [Category("RefObjItem")] public int DegreeOffset { get; }
        ...
        [Category("RefObjCommon")] public int Tid { get; }
